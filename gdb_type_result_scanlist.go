...
//
// 示例代码中的参数“User/UserDetail/UserScores”指定当前结果将绑定到的目标属性结构体。
//
// 示例代码中的“uid”是结果的表字段名，“uid”是关系结构体属性名，而不是绑定到目标的属性名。
//
// 在示例代码中，它是实体“entity”的“User”的属性名“Uid”，它自动计算具有给定<relation>参数的HasOne/HasMany关系。
//
